...
module.exports = class initialSchema1677489950678 {
    name = 'initialSchema1677489950678'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "plan_buddies_user" ("planId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_9d3a36122399fe9af2aab656ad9" PRIMARY KEY ("planId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_89dc7bfa6da8d7d39acc2c64ad" ON "plan_buddies_user" ("planId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c4835a1ae69bcc1e934bd70e6a" ON "plan_buddies_user" ("userId") `);
        ...
        await queryRunner.query(`ALTER TABLE "plan_buddies_user" ADD CONSTRAINT "FK_89dc7bfa6da8d7d39acc2c64ad4" FOREIGN KEY ("planId") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plan_buddies_user" ADD CONSTRAINT "FK_c4835a1ae69bcc1e934bd70e6a1" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "plan_buddies_user" DROP CONSTRAINT "FK_c4835a1ae69bcc1e934bd70e6a1"`);
        await queryRunner.query(`ALTER TABLE "plan_buddies_user" DROP CONSTRAINT "FK_89dc7bfa6da8d7d39acc2c64ad4"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c4835a1ae69bcc1e934bd70e6a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_89dc7bfa6da8d7d39acc2c64ad"`);
