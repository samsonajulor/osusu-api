...
module.exports = class initialSchema1677364695570 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "plan_buddies_user" ADD CONSTRAINT "FK_c4835a1ae69bcc1e934bd70e6a1" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
